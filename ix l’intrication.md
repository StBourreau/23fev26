...
Un électron possède une charge, une masse et un spin. On peut imaginer le spin comme une flèche coiffant l'électron. Il ne peut pointer que vers le haut ou vers le bas. On peut préparer deux électrons pour que leurs spins soient opposés : l’un va vers le haut, l'autre vers le bas. Leur spin total est alors nul et le restera tant que les électrons seront liés. Si l'un des spins est mesuré vers le haut, l'autre le sera vers le bas. Cela reste vrai même si les électrons sont séparés. Si on envoie deux électrons intriqués de part et d'autre d'un labo, chaque particule a un spin à la fois vers le haut et vers le bas pendant son trajet vers le détecteur. Au moment de la mesure, elle choisit l'orientation de son spin. Si un électron choisit vers le haut, l'autre choisit automatiquement vers le bas !
